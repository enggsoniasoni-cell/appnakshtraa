...
namespace MLTableGenerator
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //greet message
            //FigletFont font = FigletFont.Load(@"C:\Users\ASUS\Desktop\Projects\NakshatraaDiaries\MLTableGenerator\banner.flf");
            //Figlet figlet = new Figlet(font);
            //Console.WriteLine(figlet.ToAscii("NakshatraaDiaries"), Color.Magenta);
            Console.WriteAscii("ML Table Generator", Color.Yellow);
            Console.WriteLine("NakshatraaDiaries - 2023\n\n", Color.Magenta);
