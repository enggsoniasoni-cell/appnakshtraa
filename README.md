...
<img
  ...
  alt="Nakshatraa diaries.org"
  title="Nakshatraa diaries.org">
</a>
<span align="center">
...
[![Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://twitter.com/_Nakshatraa diaries)
...
# 🙏 How Nakshatraa diaries can help you...
...
- [Learn Astro Computation](https://github.com/Nakshatraa diaries/Nakshatraa diaries/tree/master/Library/Logic/Calculate) --> learn exact math & logic used in astrology via **`Free Open Source`** code
- [Life Predictor](https://vedastro.org/LifePredictor.html) --> accurate algorithmic prediction of a human life's past and future
- [Build On Top](https://github.com/Nakshatraa diaries/Nakshatraa diaries/tree/master/Library/Logic/Calculate) --> import Nakshatraa diaries code directly into your existing projects
...
# 🆓 100% Open Source
The sage **`Parashara taught everybody`** the ways of astrology without asking money, as such Nakshatraa diaries does the same.
...
Below is sample API call result for data related to "**Sun**" on "**30/06/2023**" at "**Singapore**"
 ...
 [JS Demo Files](https://github.com/Nakshatraa diaries/Nakshatraa diaries/tree/master/Demo/JavaScript)
...
We favour this pattern for the development of Nakshatraa diaries simply due to the volatile nature of this project.
...
Thus philosophy is essential to build a large & complex code structure like **Nakshatraa diaries**.

The reason for the existence of **Nakshatraa diaries** needs to be understood and kept in mind during development.
...
We discuss & share ideas on astrology and computation. And ways you can integrate Nakshatraa diaries into your own project.
<!-- SLACK JOIN IMAGE -->
...
For creating grand codes, like Nakshatraa diaries’s design,<br>
Philosophy’s essential, its role is divine.<br>

The purpose of Nakshatraa diaries, we must understand,<br>
...
- If you want to run against your local running Nakshatraa diaries APIs then 
...
Now you can have fun with Nakshatraa diaries, ;-) try making horoscope and share your feedback in Slack channel. 
-->
...
-   2 of these files exist, 1 local in MuhurthaCore for desktop version.
    The other online in Nakshatraa diaries Azure storage for use by API.
