...
namespace StaticTableGenerator
{
    internal class Program
    {
        ...
        {
            Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\Logic\Calculate\Calculate.cs")
        };
        static string MetadataStaticTableFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\Data\OpenAPIStaticTable.cs");
        static string PythonCalculateStubFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries.Python\NakshatraaDiaries\Library.pyi");
        static string EventDataListFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\XMLData\EventDataList.xml");
        static string EventDataListStaticTableFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\Data\EventDataListStatic.cs");
        static string HoroscopeDataListFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\XMLData\HoroscopeDataList.xml");
        static string HoroscopeDataListStaticTableFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\Data\HoroscopeDataListStatic.cs");
        static string HoroscopeNameEnumFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\Library\Data\Enum\HoroscopeName.cs");
        static string AIPredictionCSSafetyCacheFile = Path.Combine(userFolderPath, @"Desktop\Projects\NakshatraaDiaries\StaticTableGenerator\AI-MADE-DATA\AI-prediction-cs-safety-cache.csv");
    ...
    {{
        ...
        public static List<MethodDocumentation> ExtractSummaries(string[] filePaths)
        {
            ...
            foreach (var filePath in filePaths)
            {
                ...
                var compilation = CSharpCompilation.Create("NakshatraaDiaries.Library", new[] { tree });
