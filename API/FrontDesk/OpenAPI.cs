    ...
    public static class OpenAPI
    {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    // Handle SVG string
                    case nameof(NakshatraaDiaries.Library.Calculate.SkyChart):
                    case nameof(NakshatraaDiaries.Library.Calculate.SouthIndianChart):
                    case nameof(NakshatraaDiaries.Library.Calculate.NorthIndianChart):
                    ...
                    // CSV string
                    case nameof(NakshatraaDiaries.Library.Calculate.GenerateTimeListCSV):
        ...
        public static string ParseAndSetAyanamsa(string? fullParamString)
        {
            ...
            if (isCustomAyanamsa)
            {
                ...
                //set ayanamsa
                NakshatraaDiaries.Library.Calculate.Ayanamsa = (int)Tools.EnumFromUrl(ayanamsaUrl);
