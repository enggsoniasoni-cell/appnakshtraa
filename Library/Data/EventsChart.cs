...
namespace NakshatraaDiaries.Library
{
    ...
    public class EventsChart
    {
        ...
        /// </summary>
        public static async Task<EventsChart> FromJson(JObject? requestJson)
        {
            ...
            var newChart = new EventsChart(newChartId, "", foundPerson, new TimeRange(startTime, endTime), daysPerPixel, eventTags, summaryOptions);
