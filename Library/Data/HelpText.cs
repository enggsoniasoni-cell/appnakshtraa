namespace NakshatraaDiaries.Library
{
    ...
    public static class HelpText
    {
        ...
        public const string SearchPredictions = @"These are horoscope predictions that have been programmed into NakshatraaDiaries";
        ...
        public const string SearchEvents = @"These are Muhurtha events that have been programmed into NakshatraaDiaries";
