    ...
    public static class Tools
    {
        ...
        public static async Task<WebResult<XElement>> ReadFromServerXmlReply(string apiUrl)
        {
            ...
            WebResult<XElement> ParseData(string inputRawString)
            {
                ...
                try
                {
                    //OPTION 1 : xml with NakshatraaDiaries standard reply
        ...
        /// Handles all JSON replies from NakshatraaDiaries format, or raw JSON format
        /// </summary>
        ...
        /// Handles all JSON replies from NakshatraaDiaries format, or raw JSON format
        /// </summary>
        public static async Task<WebResult<JToken>> ReadFromServerJsonReplyNakshatraaDiaries(string apiUrl)
        {
            ...
            WebResult<JToken> ParseData(string inputRawString)
            {
                try
                {
                    //OPTION 1 : NakshatraaDiaries API format
        ...
        public static object EnumFromUrl(string url)
        {
            ...
            const string Namespace = "NakshatraaDiaries.Library.";
        ...
        /// <summary>
        /// Converts NakshatraaDiaries planet name to Swiss Eph planet
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// EXAMPLE: NakshatraaDiaries.Library.Calculate.List<Avasta> PlanetAvasta(PlanetName planetName, Time time)
        /// </summary>
        ...
        /// NakshatraaDiaries JSON format supported
        /// </summary>
