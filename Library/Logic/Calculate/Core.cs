...
using static NakshatraaDiaries.Library.PlanetName;
...
namespace NakshatraaDiaries.Library
{
    public partial class Calculate
    {
        ...
        public static List<string> GhatakaChakra(Time time, Time birthTime)
        {
            ...
            {
                { ZodiacName.Aries, new GhatakaRow(ZodiacName.Aries, LunarDayGroup.Nanda, NakshatraaDiaries.Library.DayOfWeek.Sunday, ConstellationName.Makha, ZodiacName.Aries, ZodiacName.Libra)},
                { ZodiacName.Taurus, new GhatakaRow(ZodiacName.Virgo, LunarDayGroup.Purna, NakshatraaDiaries.Library.DayOfWeek.Saturday, ConstellationName.Hasta, ZodiacName.Taurus, ZodiacName.Scorpio)},
                { ZodiacName.Gemini, new GhatakaRow(ZodiacName.Aquarius,LunarDayGroup.Bhadra , NakshatraaDiaries.Library.DayOfWeek.Monday , ConstellationName.Swathi ,ZodiacName.Cancer,ZodiacName.Capricorn)},
                { ZodiacName.Cancer, new GhatakaRow(ZodiacName.Leo,LunarDayGroup.Bhadra ,NakshatraaDiaries.Library.DayOfWeek.Wednesday ,ConstellationName.Anuradha,ZodiacName.Libra,ZodiacName.Aries)},
                { ZodiacName.Leo, new GhatakaRow(ZodiacName.Capricorn,LunarDayGroup.Jaya ,NakshatraaDiaries.Library.DayOfWeek.Saturday ,ConstellationName.Moola,ZodiacName.Capricorn,ZodiacName.Cancer)},
                { ZodiacName.Virgo, new GhatakaRow(ZodiacName.Gemini,LunarDayGroup.Purna ,NakshatraaDiaries.Library.DayOfWeek.Saturday ,ConstellationName.Sravana,ZodiacName.Pisces,ZodiacName.Virgo)},
                { ZodiacName.Libra, new GhatakaRow(ZodiacName.Sagittarius,LunarDayGroup.Rikta,NakshatraaDiaries.Library.DayOfWeek.Thursday,ConstellationName.Satabhisha,ZodiacName.Virgo,ZodiacName.Pisces)},
                { ZodiacName.Scorpio, new GhatakaRow(ZodiacName.Taurus,LunarDayGroup.Nanda,NakshatraaDiaries.Library.DayOfWeek.Friday,ConstellationName.Revathi,ZodiacName.Taurus,ZodiacName.Scorpio)},
                { ZodiacName.Sagittarius, new GhatakaRow(ZodiacName.Pisces,LunarDayGroup.Jaya,NakshatraaDiaries.Library.DayOfWeek.Friday,ConstellationName.Aswini,ZodiacName.Sagittarius,ZodiacName.Gemini)},
                { ZodiacName.Capricorn, new GhatakaRow(ZodiacName.Leo,LunarDayGroup.Rikta,NakshatraaDiaries.Library.DayOfWeek.Tuesday,ConstellationName.Rohini,ZodiacName.Aquarius,ZodiacName.Leo)},
                { ZodiacName.Aquarius, new GhatakaRow(ZodiacName.Sagittarius,LunarDayGroup.Jaya,NakshatraaDiaries.Library.DayOfWeek.Thursday,ConstellationName.Aridra,ZodiacName.Gemini,ZodiacName.Sagittarius)},
                { ZodiacName.Pisces, new GhatakaRow(ZodiacName.Aquarius,LunarDayGroup.Purna,NakshatraaDiaries.Library.DayOfWeek.Thursday,ConstellationName.Aslesha,ZodiacName.Leo,ZodiacName.Aquarius)}
            };
        ...
        public static NithyaYoga NithyaYoga(Time time)
        {
            ...
            var nithyaYoga = NakshatraaDiaries.Library.NithyaYoga.FromNumber(nithyaYogaNumber);
        ...
        public static Dictionary<HouseName, PlanetName> AllHouseConstellationLord(Time time)
        {
            ...
            //get for all houses
            foreach (var house in NakshatraaDiaries.Library.House.AllHouses)
            {
