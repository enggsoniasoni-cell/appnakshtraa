...
namespace Publisher
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            // Generate hash for js/NakshatraaDiaries.js file in local folder path
            string vedAstroJsPath = Path.Combine(localFolderPath, "js", "NakshatraaDiaries.js");
            string hash = GenerateFileHash(vedAstroJsPath);
            Console.WriteLine($"Generated hash for NakshatraaDiaries.js: {hash}");
